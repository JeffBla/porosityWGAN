...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.model = nn.Sequential(
            ...
            nn.ConvTranspose2d(ngf, opt.channels, 4, 2, 1, bias=False), # 3 for percent layer
            nn.Tanh(),
            # PercentLayer_dcgan()
...
generator = Generator()
generator.load_state_dict(torch.load('./model/rock/generator.pt'))
discriminator = Discriminator()
discriminator.load_state_dict(torch.load('./model/rock/discriminator.pt'))
