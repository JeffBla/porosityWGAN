...
generator = Generator()
generator.load_state_dict(torch.load('./model/rock/generator_percent_-1_1_allNoNorm.pt'))
discriminator = Discriminator()
discriminator.load_state_dict(torch.load('./model/rock/discriminator_percent_-1_1_allNoNorm.pt'))
